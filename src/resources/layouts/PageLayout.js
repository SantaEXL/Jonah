...
// <Badge bg="dark">Copyright © 2022 by Jonah David Long</Badge>
class PageLayout extends React.Component {
    render() {
        return (
            <Container fluid>
                <Row className="header justify-content-md-center">
                    <Col><Image id="pin-logo" src="/resources/images/pin-logo.png" roundedCircle="true" /></Col>
                    <Col />
                    <Col id="contact" xs={5}><Image id="phone-home" src="/resources/images/phonehome.png" roundedCircle="true" /><Badge bg="dark">(661) 378-0680</Badge> <Image id="location" src="/resources/images/location.png" roundedCircle="true" /><Badge bg="dark">4200 Glencannon st, Bakersfield, CA 93308</Badge></Col>
                </Row>
                <Row>
                    <Col>
                        <Carousel variant="light">
                            <Carousel.Item>
                                <img
                                    ...
                                    src="/resources/images/SantaJonah.jpg"
                                    alt="First slide"
                                />
                                <Carousel.Caption>
                            ...
                            <Carousel.Item>
                                <img
                                    className="d-block w-100"
                                    src="/resources/images/jonahstow.jpg"
                                    alt="Third slide"
                                />
                                <Carousel.Caption>
